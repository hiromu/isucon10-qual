...
func searchChairs(c echo.Context) error {
	...
	if c.QueryParam("priceRangeId") != "" {
		...
		conditions = append(conditions, "price_class = ?")
	...
	if c.QueryParam("heightRangeId") != "" {
		...
		conditions = append(conditions, "height_class = ?")
	...
	if c.QueryParam("widthRangeId") != "" {
		...
		conditions = append(conditions, "width_class = ?")
	...
	if c.QueryParam("depthRangeId") != "" {
		...
		conditions = append(conditions, "depth_class = ?")
	...
	if err != nil {
		if err == sql.ErrNoRows {
			c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
			c.Response().WriteHeader(http.StatusOK)
			return json.NewEncoder(c.Response()).Encode(ChairSearchResponse{Count: 0, Chairs: []Chair{}})
		}
		c.Logger().Errorf("searchChairs DB execution error : %v", err)
		return c.NoContent(http.StatusInternalServerError)
	}
...
func getChairSearchCondition(c echo.Context) error {
	c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
	c.Response().WriteHeader(http.StatusOK)
	return json.NewEncoder(c.Response()).Encode(chairSearchCondition)
}
...
func getLowPricedChair(c echo.Context) error {
	...
	if err != nil {
		if err == sql.ErrNoRows {
			...
			c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
			c.Response().WriteHeader(http.StatusOK)
			return json.NewEncoder(c.Response()).Encode(ChairListResponse{[]Chair{}})
		}
...
func getEstateDetail(c echo.Context) error {
	...
	c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
	c.Response().WriteHeader(http.StatusOK)
	return json.NewEncoder(c.Response()).Encode(estate)
}
...
func searchEstates(c echo.Context) error {
	...
	if err != nil {
		if err == sql.ErrNoRows {
			c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
			c.Response().WriteHeader(http.StatusOK)
			return json.NewEncoder(c.Response()).Encode(EstateSearchResponse{Count: 0, Estates: []Estate{}})
		}
		c.Logger().Errorf("searchEstates DB execution error : %v", err)
		return c.NoContent(http.StatusInternalServerError)
	}
...
func getLowPricedEstate(c echo.Context) error {
	...
	if err != nil {
		if err == sql.ErrNoRows {
			...
			c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
			c.Response().WriteHeader(http.StatusOK)
			return json.NewEncoder(c.Response()).Encode(EstateListResponse{[]Estate{}})
		}
...
func searchEstateNazotte(c echo.Context) error {
	...
	c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
	c.Response().WriteHeader(http.StatusOK)
	return json.NewEncoder(c.Response()).Encode(re)
}
...
func getEstateSearchCondition(c echo.Context) error {
	c.Response().Header().Set(echo.HeaderContentType, echo.MIMEApplicationJSONCharsetUTF8)
	c.Response().WriteHeader(http.StatusOK)
	return json.NewEncoder(c.Response()).Encode(estateSearchCondition)
}
